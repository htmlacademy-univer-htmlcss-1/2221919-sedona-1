...
* Студент: [Вадим Котов](https://up.htmlacademy.ru/univer-html1/1/user/2221919).
* Наставник: `Самохвалов Алексей Владимирович`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-univer-htmlcss-1/2221919-sedona-1) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
